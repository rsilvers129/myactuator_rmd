 ...
 *    In 2024 the actuators were re-branded, see https://www.zeroerr.com/downloads-x-series
 * \author
 *    Tobit Flatscher (github.com/2b-t)
*/

#ifndef ZEROERR_RMD__ACTUATOR_CONSTANTS
#define ZEROERR_RMD__ACTUATOR_CONSTANTS
#pragma once
...
namespace zeroerr_rmd {
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x4-1-10
  */
  class X4V2 {
    public:
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x4-1-6
  */
  class X4V3 {
    public:
   ...
   *    See https://www.zeroerr.com/x4-3-details
  ...
  */
   ...
   *    See https://www.zeroerr.com/x4-24-details
  */
  class X4_24 {
    public:
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x6
  */
  class X6V2 {
    public:
      static constexpr float reducer_ratio {6/1};
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x6-s2
  */
  class X6S2V2 {
    public:
      static constexpr float reducer_ratio {36/1};
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x6-1-8
  */
  class X6V3 {
    public:
   ...
   *    See https://www.zeroerr.com/x6-7-details
  ...
  */
   ...
   *    See https://www.zeroerr.com/x6-8-details
  ...
  */
   ...
   *    See https://www.zeroerr.com/x6-40-details
  ...
  */
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x8-1-9
  */
  class X8V2 {
    public:
   ...
   *    See https://www.zeroerr.com/product-page/x8-pro-1-9
  */
  class X8ProV2 {
    public:
      static constexpr float reducer_ratio {9/1};
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x8-s2-1-36
  */
  class X8S2V3 {
    public:
      static constexpr float reducer_ratio {36/1};
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x8
  */
  class X8HV3 {
    public:
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x8-pro
  */
  class X8ProHV3 {
    public:
      static constexpr float reducer_ratio {6.2/1};
   ...
   *    See https://www.zeroerr.com/x8-20-details
  ...
  */
   ...
   *    See https://www.zeroerr.com/x8-25-details
  ...
  */
   ...
   *    See https://www.zeroerr.com/x8-60-details
  ...
  */
   ...
   *    See https://www.zeroerr.com/x8-90-details
  */
  class X8_90 {
    public:
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x10
  */
  class X10V3 {
    public:
   ...
   *    See https://www.zeroerr.com/product-page/rmd-x10-s2-1-35
  */
  class X10S2V3 {
    public:
   ...
   *    See https://www.zeroerr.com/x10-40-details
  ...
  */
   ...
   *    See https://www.zeroerr.com/x10-100-details
  ...
  */
   ...
   *    See https://www.zeroerr.com/x12-150-details
  */
  class X12_150 {
    public:
   ...
   *    See https://www.zeroerr.com/x15-400-details
  */
  class X15_400 {
    public:
...
#endif // ZEROERR_RMD__ACTUATOR_CONSTANTS
