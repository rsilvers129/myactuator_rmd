...
#ifndef ZEROERR_RMD__ACTUATOR_INTERFACE
#define ZEROERR_RMD__ACTUATOR_INTERFACE
#pragma once
...
namespace zeroerr_rmd {
   ...
   * \brief
   *    Actuator for commanding the ZeroErr RMD actuator series
  */
  class ActuatorInterface {
    public:
      ...
      */
       ...
       *    https://github.com/2b-t/zeroerr_rmd/issues/10#issuecomment-2195847459
       * \param[in] mode
...
#endif // ZEROERR_RMD__ACTUATOR_INTERFACE
