...
namespace zeroerr_rmd {
  namespace test {
    ...
    TEST(ToTimevalTest, predefinedDurationTypes) {
      ...
      auto const t1 {2s};
      auto const tv1 {zeroerr_rmd::toTimeval(t1)};
      EXPECT_EQ(tv1.tv_sec, 2);
      EXPECT_EQ(tv1.tv_usec, 0);

      auto const t2 {20ms};
      auto const tv2 {zeroerr_rmd::toTimeval(t2)};
      EXPECT_EQ(tv2.tv_sec, 0);
      EXPECT_EQ(tv2.tv_usec, 20000);

      auto const t3 {7us};
      auto const tv3 {zeroerr_rmd::toTimeval(t3)};
      EXPECT_EQ(tv3.tv_sec, 0);
      EXPECT_EQ(tv3.tv_usec, 7);

      auto const t4 {2min};
      auto const tv4 {zeroerr_rmd::toTimeval(t4)};
