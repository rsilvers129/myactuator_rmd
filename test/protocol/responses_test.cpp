...
namespace zeroerr_rmd {
  namespace test {
    ...
    TEST(GetCanIdResponseTest, parsing) {
      zeroerr_rmd::GetCanIdResponse const request {{0x79, 0x00, 0x00, 0x00, 0x00, 0x00, 0x42, 0x02}};
      std::uint16_t const can_id {request.getCanId()};
      EXPECT_EQ(can_id, 0x242);
    }

    TEST(GetAccelerationResponseTest, parsing) {
      zeroerr_rmd::GetAccelerationResponse const response {{0x42, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
    ...
    TEST(GetControllerGainsResponseTest, parsing) {
      zeroerr_rmd::GetControllerGainsResponse const response {{0x30, 0x00, 0x55, 0x19, 0x55, 0x19, 0x55, 0x19}};
      zeroerr_rmd::Gains const gains {response.getGains()};
    ...
    TEST(GetControlModeResponseTest, parsing) {
      zeroerr_rmd::GetControlModeResponse const response {{0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03}};
      zeroerr_rmd::ControlMode const control_mode {response.getMode()};
      EXPECT_EQ(control_mode, ControlMode::POSITION);
    }

    TEST(GetMotorModelResponseTest, parsing) {
      zeroerr_rmd::GetMotorModelResponse const response {{0xB5, 0x58, 0x38, 0x53, 0x32, 0x56, 0x31, 0x30}};
      std::string const version {response.getModel()};
      EXPECT_EQ(version, "X8S2V10");
    }

    TEST(GetMotorPowerResponseTest, parsing) {
      zeroerr_rmd::GetMotorPowerResponse const response {{0x71, 0x00, 0x00, 0x00, 0x00, 0x00, 0xD0, 0x07}};
      auto const motor_power {response.getPower()};
      EXPECT_NEAR(motor_power, 200.0f, 0.1f);
    }

    TEST(GetMotorStatus1ResponseTest, parsing) {
      zeroerr_rmd::GetMotorStatus1Response const response {{0x9A, 0x32, 0x00, 0x01, 0xE5, 0x01, 0x04, 0x00}};
      zeroerr_rmd::MotorStatus1 const motor_status {response.getStatus()};
      ...
      EXPECT_EQ(motor_status.error_code, zeroerr_rmd::ErrorCode::LOW_VOLTAGE);
    }

    TEST(GetMotorStatus2ResponseTest, parsing) {
      zeroerr_rmd::GetMotorStatus2Response const response {{0x9C, 0x32, 0x64, 0x00, 0xF4, 0x01, 0x2D, 0x00}};
      zeroerr_rmd::MotorStatus2 const motor_status {response.getStatus()};
      EXPECT_EQ(motor_status.temperature, 50);
    ...
    TEST(GetMotorStatus3ResponseTest, parsing) {
      zeroerr_rmd::GetMotorStatus3Response const response {{0x9D, 0x32, 0xC2, 0x0B, 0x10, 0xFA, 0xC0, 0xF9}};
      zeroerr_rmd::MotorStatus3 const motor_status {response.getStatus()};
      EXPECT_EQ(motor_status.temperature, 50);
    ...
    TEST(GetMultiTurnAngleResponseTest, parsing) {
      zeroerr_rmd::GetMultiTurnAngleResponse const response {{0x92, 0x00, 0x00, 0x00, 0xA0, 0x8C, 0x00, 0x00}};
      auto const angle {response.getAngle()};
      EXPECT_NEAR(angle, 360.0f, 0.1f);
    }

    TEST(GetMultiTurnEncoderPositionResponseTest, parsing) {
      zeroerr_rmd::GetMultiTurnEncoderPositionResponse const response {{0x60, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
    ...
    TEST(GetMultiTurnEncoderOriginalPositionResponseTest, parsing) {
      zeroerr_rmd::GetMultiTurnEncoderOriginalPositionResponse const response {{0x61, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
      auto const encoder_position {response.getPosition()};
      EXPECT_EQ(encoder_position, 10000);
    }

    TEST(GetMultiTurnEncoderZeroOffsetResponseTest, parsing) {
      zeroerr_rmd::GetMultiTurnEncoderZeroOffsetResponse const response {{0x62, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
      auto const encoder_position {response.getPosition()};
      EXPECT_EQ(encoder_position, 10000);
    }

    TEST(GetSingleTurnAngleResponseTest, parsing) {
      zeroerr_rmd::GetSingleTurnAngleResponse const response {{0x94, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x27}};
      auto const angle {response.getAngle()};
      EXPECT_NEAR(angle, 100.0f, 0.1f);
    }

    TEST(GetSingleTurnEncoderPositionResponseTest, parsing) {
      zeroerr_rmd::GetSingleTurnEncoderPositionResponse const response {{0x90, 0x00, 0x33, 0x08, 0xBE, 0x2C, 0x8B, 0x24}};
      auto const encoder_position {response.getPosition()};
    ...
    TEST(GetSystemRuntimeResponseTest, parsing) {
      zeroerr_rmd::GetSystemRuntimeResponse const response {{0xB1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10}};
      auto const runtime {response.getRuntime()};
      EXPECT_EQ(runtime.count(), 268435456);
    }

    TEST(GetVersionDateResponseTest, parsing) {
      zeroerr_rmd::GetVersionDateResponse const response {{0xB2, 0x00, 0x00, 0x00, 0x2E, 0x89, 0x34, 0x01}};
      auto const version {response.getVersion()};
      EXPECT_EQ(version, 20220206);
    }

    TEST(SetCurrentPositionAsEncoderZeroResponseTest, parsing) {
      zeroerr_rmd::SetCurrentPositionAsEncoderZeroResponse const response {{0x64, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00}};
    ...
    TEST(SetPositionAbsoluteResponseTest, parsingPositiveValues) {
      zeroerr_rmd::SetPositionAbsoluteResponse const response {{0xA4, 0x32, 0x64, 0x00, 0xF4, 0x01, 0x2D, 0x00}};
      zeroerr_rmd::Feedback const feedback {response.getStatus()};
    ...
    TEST(SetPositionAbsoluteResponseTest, parsingNegativeValues) {
      zeroerr_rmd::SetPositionAbsoluteResponse const response {{0xA4, 0x32, 0x9C, 0xFF, 0x0C, 0xFE, 0xD3, 0xFF}};
      zeroerr_rmd::Feedback const feedback {response.getStatus()};
      EXPECT_EQ(feedback.temperature, 50);
      EXPECT_NEAR(feedback.current, -1.0f, 0.1f);
      EXPECT_NEAR(feedback.shaft_speed, -500.0f, 0.1f);
    ...
    TEST(SetTorqueResponseTest, parsingPositiveValues) {
      zeroerr_rmd::SetTorqueResponse const response {{0xA1, 0x32, 0x64, 0x00, 0xF4, 0x01, 0x2D, 0x00}};
      zeroerr_rmd::Feedback const feedback {response.getStatus()};
      EXPECT_EQ(feedback.temperature, 50);
      EXPECT_NEAR(feedback.current, 1.0f, 0.1f);
      EXPECT_NEAR(feedback.shaft_speed, 500.0f, 0.1f);
    ...
    TEST(SetTorqueResponseTest, parsingNegativeValues) {
      zeroerr_rmd::SetTorqueResponse const response {{0xA1, 0x32, 0x9C, 0xFF, 0x0C, 0xFE, 0xD3, 0xFF}};
      zeroerr_rmd::Feedback const feedback {response.getStatus()};
      EXPECT_EQ(feedback.temperature, 50);
      EXPECT_NEAR(feedback.current, -1.0f, 0.1f);
      EXPECT_NEAR(feedback.shaft_speed, -500.0f, 0.1f);
    ...
    TEST(SetVelocityResponseTest, parsingPositiveValues) {
      zeroerr_rmd::SetVelocityResponse const response {{0xA2, 0x32, 0x64, 0x00, 0xF4, 0x01, 0x2D, 0x00}};
      zeroerr_rmd::Feedback const feedback {response.getStatus()};
      EXPECT_EQ(feedback.temperature, 50);
      EXPECT_NEAR(feedback.current, 1.0f, 0.1f);
      EXPECT_NEAR(feedback.shaft_speed, 500.0f, 0.1f);
    ...
    TEST(SetVelocityResponseTest, parsingNegativeValues) {
      zeroerr_rmd::SetVelocityResponse const response {{0xA2, 0x32, 0x9C, 0xFF, 0x0C, 0xFE, 0xD3, 0xFF}};
      zeroerr_rmd::Feedback const feedback {response.getStatus()};
      EXPECT_EQ(feedback.temperature, 50);
      EXPECT_NEAR(feedback.current, -1.0f, 0.1f);
      EXPECT_NEAR(feedback.shaft_speed, -500.0f, 0.1f);
